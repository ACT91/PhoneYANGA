  ...
  return (
    <div className="min-h-screen bg-base-200 p-4">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold">PhoneYANGA Dashboard</h1>
      ...
      {/* Quick Stats */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <Link to="/messages" className="card bg-blue-100 text-blue-800 shadow hover:shadow-lg transition-shadow">
          <div className="card-body">
        ...
        <Link to="/calls" className="card bg-green-100 text-green-800 shadow hover:shadow-lg transition-shadow">
          <div className="card-body">
        ...
        <Link to="/notifications" className="card bg-gray-100 text-gray-800 shadow hover:shadow-lg transition-shadow">
          <div className="card-body">
